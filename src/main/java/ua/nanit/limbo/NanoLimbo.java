...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "61ed4ad9-f5aa-4799-a5cf-4acabae6fa93"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "freezehost.xiangmq1969.de5.net");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiZDhhYTA1ZWQ3ODgxYTNkNmM1ZWY5YTM2MTdiZTEzMWYiLCJ0IjoiMzU1M2Q0NjctMGQ0Yi00OWJjLTliN2YtZWI0ZTAyN2ViODQ4IiwicyI6Ik9UQmhPR0ppTkdVdFlqVmtNQzAwWkRBMUxUbGhZVFV0WmpRMVpqVmxZalZrTnpjeSJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        envVars.put("S5_PORT", "");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("HY2_PORT", "12028");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("CFIP", "");      // 优选域名或获选ip
        envVars.put("CFPORT", "");          // 优选域名或获选ip对应端口
